...
load(
    ...
    _amtool_routes_test = "amtool_routes_test",
    _amtool_routes_multi_test = "amtool_routes_multi_test",
)
load(
...
amtool_routes_test = _amtool_routes_test
amtool_routes_multi_test = _amtool_routes_multi_test
